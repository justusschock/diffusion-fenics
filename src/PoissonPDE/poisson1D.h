...
class poisson1d_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  poisson1d_cell_integral_1_otherwise() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson1d_cell_integral_1_otherwise()
  {
    // Do nothing
  }
...
class poisson1d_exterior_facet_integral_1_otherwise: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  poisson1d_exterior_facet_integral_1_otherwise() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson1d_exterior_facet_integral_1_otherwise()
  {
    // Do nothing
  }
...
class poisson1d_form_1: public ufc::form
{
public:

  /// Constructor
  poisson1d_form_1() : ufc::form()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson1d_form_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::cell_integral* create_default_cell_integral() const
  {
    return new poisson1d_cell_integral_1_otherwise();
  }

  /// Create a new exterior facet integral on everywhere else
  virtual ufc::exterior_facet_integral* create_default_exterior_facet_integral() const
  {
    return new poisson1d_exterior_facet_integral_1_otherwise();
  }
...
public:
  ...
  CoefficientSpace_f(const dolfin::Restriction& restriction):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(restriction.mesh()),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new poisson1d_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new poisson1d_dofmap_0()),
...
public:
    ...
    dolfin::Form(1, 2), f(*this, 0), g(*this, 1)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new poisson1d_form_1());
  }
