...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_finite_element_0()
  {
    // Do nothing
  }
...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_dofmap_0()
  {
    // Do nothing
  }
...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_cell_integral_0_otherwise()
  {
    // Do nothing
  }
...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_cell_integral_1_otherwise()
  {
    // Do nothing
  }
...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_exterior_facet_integral_1_otherwise()
  {
    // Do nothing
  }
...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_form_0()
  {
    // Do nothing
  }
...
public:
  ...
  /// Destructor
  virtual ~poissonproblem1d_form_1()
  {
    // Do nothing
  }
...
public:
  ...
  CoefficientSpace_f(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new poissonproblem1d_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new poissonproblem1d_dofmap_0()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new poissonproblem1d_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new poissonproblem1d_dofmap_0()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new poissonproblem1d_form_0());
  }
...
public:
    ...
    dolfin::Form(1, 2), f(*this, 0), g(*this, 1)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new poissonproblem1d_form_1());
  }
