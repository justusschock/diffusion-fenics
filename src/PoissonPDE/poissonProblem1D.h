...
#ifndef __POISSONPROBLEM1D_H
#define __POISSONPROBLEM1D_H
#include <stdexcept>
#include <ufc.h>

class poissonproblem1d_finite_element_0: public ufc::finite_element
{
public:

  poissonproblem1d_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  ~poissonproblem1d_finite_element_0() override
  {
    // Do nothing
  }
  ...
  {
    return new poissonproblem1d_finite_element_0();
  }

};


class poissonproblem1d_finite_element_1: public ufc::finite_element
{
public:

  poissonproblem1d_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }

  ~poissonproblem1d_finite_element_1() override
  {
    // Do nothing
  }
  ...
  ufc::finite_element * create() const final override
  {
    return new poissonproblem1d_finite_element_1();
  }

};


class poissonproblem1d_dofmap_0: public ufc::dofmap
{
public:

  poissonproblem1d_dofmap_0() : ufc::dofmap()
  {
    // Do nothing
  }

  ~poissonproblem1d_dofmap_0() override
  {
    // Do nothing
  }
  ...
  {
    return new poissonproblem1d_dofmap_0();
  }

};


class poissonproblem1d_dofmap_1: public ufc::dofmap
{
public:

  poissonproblem1d_dofmap_1() : ufc::dofmap()
  {
    // Do nothing
  }

  ~poissonproblem1d_dofmap_1() override
  {
    // Do nothing
  }
  ...
  ufc::dofmap * create() const final override
  {
    return new poissonproblem1d_dofmap_1();
  }

};


class poissonproblem1d_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  poissonproblem1d_cell_integral_0_otherwise() : ufc::cell_integral()
  {
    
  }

  ~poissonproblem1d_cell_integral_0_otherwise() override
  {
...
class poissonproblem1d_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  poissonproblem1d_cell_integral_1_otherwise() : ufc::cell_integral()
  {
    
  }

  ~poissonproblem1d_cell_integral_1_otherwise() override
  {
...
class poissonproblem1d_exterior_facet_integral_1_otherwise: public ufc::exterior_facet_integral
{
public:

  poissonproblem1d_exterior_facet_integral_1_otherwise() : ufc::exterior_facet_integral()
  {
    
  }

  ~poissonproblem1d_exterior_facet_integral_1_otherwise() override
  {
...
class poissonproblem1d_form_0: public ufc::form
{
public:

  poissonproblem1d_form_0() : ufc::form()
  {
    // Do nothing
  }

  ~poissonproblem1d_form_0() override
  {
    // Do nothing
  }
  ...
  {
    return new poissonproblem1d_cell_integral_0_otherwise();
  }
...
class poissonproblem1d_form_1: public ufc::form
{
public:

  poissonproblem1d_form_1() : ufc::form()
  {
    // Do nothing
  }

  ~poissonproblem1d_form_1() override
  {
    // Do nothing
  }
  ...
  ufc::cell_integral * create_default_cell_integral() const final override
  {
    return new poissonproblem1d_cell_integral_1_otherwise();
  }

  ufc::exterior_facet_integral * create_default_exterior_facet_integral() const final override
  {
    return new poissonproblem1d_exterior_facet_integral_1_otherwise();
  }
...
public:
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<poissonproblem1d_finite_element_0>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<poissonproblem1d_dofmap_0>(), *mesh))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::make_shared<const dolfin::FiniteElement>(std::make_shared<poissonproblem1d_finite_element_0>()),
                          std::make_shared<const dolfin::DofMap>(std::make_shared<poissonproblem1d_dofmap_0>(), *mesh, constrained_domain))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::make_shared<const poissonproblem1d_form_0>();
  }
...
public:
    ...
    dolfin::Form(1, 2), f(*this, 0), g(*this, 1)
  {
    ...
    _ufc_form = std::make_shared<const poissonproblem1d_form_1>();
  }
