...
#ifndef __CURRENT1D_H
#define __CURRENT1D_H
...
class current1d_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  current1d_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_finite_element_0()
  {
    // Do nothing
  }
  ...
  {
    return new current1d_finite_element_0();
  }
...
class current1d_dofmap_0: public ufc::dofmap
{
public:

  /// Constructor
  current1d_dofmap_0() : ufc::dofmap()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_dofmap_0()
  {
    // Do nothing
  }
...
class current1d_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  current1d_cell_integral_0_otherwise() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_cell_integral_0_otherwise()
  {
    // Do nothing
  }
                               ...
                               int cell_orientation) const
  {
    ...
    const double G1_0_0_0 = det*w[0][0]*(K[0]*K[0]);
    const double G1_1_0_0 = det*w[0][1]*(K[0]*K[0]);
    
    // Compute element tensor
    A[0] = -0.5*G0_0_0_0 + 0.5*G0_0_1_0 - 0.5*G1_0_0_0 - 0.5*G1_1_0_0;
    A[1] = -0.5*G0_0_0_0 + 0.5*G0_0_1_0 + 0.5*G1_0_0_0 + 0.5*G1_1_0_0;
    A[2] = 0.5*G0_0_0_0 - 0.5*G0_0_1_0 + 0.5*G1_0_0_0 + 0.5*G1_1_0_0;
    A[3] = 0.5*G0_0_0_0 - 0.5*G0_0_1_0 - 0.5*G1_0_0_0 - 0.5*G1_1_0_0;
  }
...
class current1d_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  current1d_cell_integral_1_otherwise() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_cell_integral_1_otherwise()
  {
    // Do nothing
  }
...
class current1d_exterior_facet_integral_1_otherwise: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  current1d_exterior_facet_integral_1_otherwise() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_exterior_facet_integral_1_otherwise()
  {
    // Do nothing
  }
...
class current1d_form_0: public ufc::form
{
public:

  /// Constructor
  current1d_form_0() : ufc::form()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_form_0()
  {
    // Do nothing
  }
  ...
  virtual const char* signature() const
  {
    return "7bfd2482f95f1bcfe8b775777055d70ae2b56fafd171fb03b788322c2f00bc2435eab0d1b07ffdfefa78d515bb9fc248bf26f0692fc2e152df21b4b4e860ece1";
  }
  ...
  {
    return new current1d_cell_integral_0_otherwise();
  }
...
class current1d_form_1: public ufc::form
{
public:

  /// Constructor
  current1d_form_1() : ufc::form()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~current1d_form_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::cell_integral* create_default_cell_integral() const
  {
    return new current1d_cell_integral_1_otherwise();
  }

  /// Create a new exterior facet integral on everywhere else
  virtual ufc::exterior_facet_integral* create_default_exterior_facet_integral() const
  {
    return new current1d_exterior_facet_integral_1_otherwise();
  }
...
public:
  ...
  CoefficientSpace_f(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new current1d_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new current1d_dofmap_0()), mesh)))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new current1d_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new current1d_dofmap_0()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 1), sigma(*this, 0)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new current1d_form_0());
  }
...
public:
    ...
    dolfin::Form(1, 2), f(*this, 0), g(*this, 1)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new current1d_form_1());
  }
